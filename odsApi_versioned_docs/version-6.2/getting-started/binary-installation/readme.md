...
This section describes how to set up the Ed-Fi ODS / API using the release binaries listed in [Binary Releases](../../getting-started/binary-installation/binary-releases.md). This is a recommend approach for implementations that have no requirement to extend or customize the source code of the Ed-Fi ODS / API.
...
:::note
 ...
 [PGDockerSetup.zip](https://edfi.atlassian.net/wiki/download/attachments/18219081/PGDockerSetup.zip?version=1&modificationDate=1710953708010&cacheVersion=1&api=v2)
