...
*   [Step 5. Run the Bootstrap Script to Load Descriptors and Education Organizations](#step-5-run-the-bootstrap-script-to-load-descriptors-and-education-organizations)
...
*  For Postgres Only, Please update Key & Secret    "-k", "**E**mpty",  "-s", "empty**S**ecret"
...
this how-to article.
[Ed-Fi-TPDMDataLoad.zip](https://edfi.atlassian.net/wiki/download/attachments/18219573/Ed-Fi-TPDMDataLoad.zip?version=1&modificationDate=1710953738117&cacheVersion=1&api=v2)
...
The following GitHub links contain the sample XML files and the as-shipped
TPDM Descriptor XML. [TPDM Sample XML](https://github.com/Ed-Fi-Alliance-OSS/Ed-Fi-TPDM-Artifacts/tree/Data-Standard-v4.0.0/Samples/Sample%20XML) 
[TPDM Descriptors](https://github.com/Ed-Fi-Alliance-OSS/Ed-Fi-TPDM-Artifacts/tree/Data-Standard-v4.0.0/Descriptors)
