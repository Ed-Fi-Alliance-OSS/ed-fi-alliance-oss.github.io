...
*   This article uses the [student transportation extension](../how-to-guides/how-to-extend-the-ed-fi-ods-api-student-transportation-example.md) as an example.
...
This step is optional. If you have followed through [How To: Extend the Ed-Fi ODS / API - Student Transportation Example](../how-to-guides/how-to-extend-the-ed-fi-ods-api-student-transportation-example.md) and have run initdev, code generation is already completed.
