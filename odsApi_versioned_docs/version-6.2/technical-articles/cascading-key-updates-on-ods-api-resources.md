...
all existing foreign key values are updated to the new key value. [1](#configure-cascading-updates-on-an-ed-fi-extension-resource)
...
[here](../how-to-guides/how-to-extend-the-ed-fi-ods-api-student-transportation-example.md).
