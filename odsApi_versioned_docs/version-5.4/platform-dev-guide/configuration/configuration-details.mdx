...
| EdFi.Ods.WebApi | appsettings.json | ApiSettings:Mode | Example: Sandbox, SharedInstance, YearSpecific, DistrictSpecific<br/>The component settings for the API. See the [following section](../extensibility-customization/readme.md) on Developers' Guide for more information on this setting. |
...
A deployment to a staging or production instance is usually more involved, and requires additional configuration. Required configurations for a production instance can be found in the [Deployment](../deployment/readme.md) section of this documentation.
...
| EdFi.Ods.WebApi | appsettings.json | ApiSettings:Features:ChangeQueries | true<br/>Enables the [Changed Record Queries](../features/changed-record-queries.md) endpoints (database configuration remains a separate step, see [Using the Changed Record Queries](../../client-developers-guide/using-the-changed-record-queries.md)). |
...
| EdFi.Ods.WebApi | appsettings.json | ApiSettings:Features:UniqueIdValidation | false<br/>Enables [Unique ID System Integration](../../technical-articles/unique-id-system-integration.md). Must implement IUniqueIdToIdValueMapper and register within the implementation within the WebApi. |
...
![Secret Manager CLI](https://edfidocs.blob.core.windows.net/$webhttps://edfidocs.blob.core.windows.net/$web/img/reference/ods-api/image2021-3-19_12-8-29.png)
...
![Manage User Secrets](https://edfidocs.blob.core.windows.net/$webhttps://edfidocs.blob.core.windows.net/$web/img/reference/ods-api/image2021-3-19_12-6-13.png)
...
![Secret.json example](https://edfidocs.blob.core.windows.net/$webhttps://edfidocs.blob.core.windows.net/$web/img/reference/ods-api/image2021-3-12_16-47-40.png)
