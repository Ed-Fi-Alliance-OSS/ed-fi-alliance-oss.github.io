...
* **Ed-Fi Data Standard Documentation**. The definitions for the data elements in the API and the XML bulk upload schema are part of the Ed-Fi Data Standard. You can view the online documentation for the data standard [here](https://docs.ed-fi.org/reference/data-exchange/api-guidelines/).
...
* **Ed-Fi API Platform Developers' Guide**. If you're interested in what's going on under the hood of the API surface, check out the Ed-Fi ODS / API Platform Developers' Guide available locally [here](../platform-dev-guide/overview.md).
