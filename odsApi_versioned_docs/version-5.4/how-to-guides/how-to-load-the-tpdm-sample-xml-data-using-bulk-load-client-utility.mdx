...
This article describes the steps needed to populate an Ed-Fi ODS with sample TPDM XML data using the [Ed-Fi Bulk Load Client](../platform-dev-guide/utilities/bulk-load-client-utility.md) utility. It assumes you have deployed TPDM plugin as described in the article [How To: Deploy TPDM As Dynamic Plugin](https://edfi.atlassian.net/wiki/display/ODSAPIS3V53/How+To%3A+Deploy+TPDM+As+Dynamic+Plugin). This process works very similarly to [How To: Load the ODS with Sample XML Data using Bulk Load Client Utility](./how-to-load-the-ods-with-sample-xml-data-using-bulk-load-client-utility.mdx).
