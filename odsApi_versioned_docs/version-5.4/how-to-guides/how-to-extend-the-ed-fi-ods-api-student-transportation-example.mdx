...
![Student Transportation Diagram](https://edfidocs.blob.core.windows.net/$webhttps://edfidocs.blob.core.windows.net/$web/img/reference/ods-api/Student-Transportation-Visio-Diagram.png)
...
![Create New Extension Project](https://edfidocs.blob.core.windows.net/$webhttps://edfidocs.blob.core.windows.net/$web/img/reference/ods-api/image-2023-4-14_10-49-55.png)
...
![Update package.json](https://edfidocs.blob.core.windows.net/$webhttps://edfidocs.blob.core.windows.net/$web/img/reference/ods-api/image-2023-4-14_10-52-47.png)
...
![New File](https://edfidocs.blob.core.windows.net/$webhttps://edfidocs.blob.core.windows.net/$web/img/reference/ods-api/NewFile.png)

Name the new file StudentTransportation.metaed to match the name of the new entity to be created.

![New StudentTransportation File](https://edfidocs.blob.core.windows.net/$webhttps://edfidocs.blob.core.windows.net/$web/img/reference/ods-api/NewFile-StudentTransportation.png)
...
![StudentTransportation Code](https://edfidocs.blob.core.windows.net/$webhttps://edfidocs.blob.core.windows.net/$web/img/reference/ods-api/NewFile-StudentTransportation-Code.png)
...
![StudentTransportation Interchange](https://edfidocs.blob.core.windows.net/$webhttps://edfidocs.blob.core.windows.net/$web/img/reference/ods-api/NewFile-Interchange-StudentTransportation-Code.png)
...
![Build](https://edfidocs.blob.core.windows.net/$webhttps://edfidocs.blob.core.windows.net/$web/img/reference/ods-api/Build.png)

Artifacts build successfully. Note that you may have to refresh the Explorer
tree to see the MetaEd Output

![Successful Build](https://edfidocs.blob.core.windows.net/$webhttps://edfidocs.blob.core.windows.net/$web/img/reference/ods-api/Successful%2520Build%2520Refresh%2520Explorer.png)
...
![MetaEd Output](https://edfidocs.blob.core.windows.net/$webhttps://edfidocs.blob.core.windows.net/$web/img/reference/ods-api/MetaEdOutput.png)
...
1. To add a project to your Ed-Fi-Ods Visual Studio Solution, right-click on the Ed-Fi Extensions Folder. Select Add > New Project.
   ...
   ![Add New Project](https://edfidocs.blob.core.windows.net/$webhttps://edfidocs.blob.core.windows.net/$web/img/reference/ods-api/VisualStudio-AddNewProject.png)

2. Search and select the Ed-Fi API Extensions Project Template option and click Next.

   ![Create Extension Project](https://edfidocs.blob.core.windows.net/$webhttps://edfidocs.blob.core.windows.net/$web/img/reference/ods-api/vs-create%2520extension%2520project.png)

   In the Project Name field enter EdFi.Ods.Extensions.SampleStudentTransportation and click Create.

   ![Name Extension Project](https://edfidocs.blob.core.windows.net/$webhttps://edfidocs.blob.core.windows.net/$web/img/reference/ods-api/vs-create%2520extension%2520project%25202.png)
...
1. Right-click on the EdFi.Ods.Extensions.ExtensionName.nuspec file in newly created EdFi.Ods.Extensions.SampleStudentTransportation project and Rename the file to EdFi.Ods.Extensions.SampleStudentTransportation.nuspec.
   ...
   ![Rename Marker File](https://edfidocs.blob.core.windows.net/$webhttps://edfidocs.blob.core.windows.net/$web/img/reference/ods-api/image2021-4-7_17-27-38.png)

2. When prompted choose to rename all references to the code element Marker_EdFi_Ods_Extensions_ExtensionName.

   ![Confirm Rename](https://edfidocs.blob.core.windows.net/$webhttps://edfidocs.blob.core.windows.net/$web/img/reference/ods-api/extension-rename-marker-confirm.png)
...
1. Locate the EdFi.Ods.WebApi project, within the "Entry Points" folder. Right-click, select Add > Project Reference..., then select the EdFi.Ods.Extensions.SampleStudentTransportation project.
   ...
   ![Add Reference](https://edfidocs.blob.core.windows.net/$webhttps://edfidocs.blob.core.windows.net/$web/img/reference/ods-api/vs-extension%2520add%2520reference.png)
...
![Settings](https://edfidocs.blob.core.windows.net/$webhttps://edfidocs.blob.core.windows.net/$web/img/reference/ods-api/Settings.png)
...
![Deploy](https://edfidocs.blob.core.windows.net/$webhttps://edfidocs.blob.core.windows.net/$web/img/reference/ods-api/Deploy.png)
...
Note that in 0001-StudentTransportation_ResourceClaims.sql script above, the resulting ClaimName value is
...
steps outlined in the [Getting Started Guide](../getting-started/source-code-installation/readme.md) (i.e., from a PowerShell prompt run `Initialize-PowershellForDevelopment.ps` script, followed by the `initdev` command). Then, run the application and view the Ed-Fi ODS / API in the Swagger
UI. The following new API resource should be visible:

![Swagger UI](https://edfidocs.blob.core.windows.net/$webhttps://edfidocs.blob.core.windows.net/$web/img/reference/ods-api/extension%2520swagger.png)
...
1. Right-click on the EdFi.Ods.Extensions.ExtensionName.nuspec file in newly created EdFi.Ods.Extensions.SampleStudentTransportation project and Rename the file to EdFi.Ods.Extensions.SampleStudentTransportation.nuspec.
   ...
   ![Rename Marker File](https://edfidocs.blob.core.windows.net/$webhttps://edfidocs.blob.core.windows.net/$web/img/reference/ods-api/image2021-4-7_17-31-14.png)
