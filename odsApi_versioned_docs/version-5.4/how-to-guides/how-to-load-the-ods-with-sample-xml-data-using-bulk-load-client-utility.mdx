...
This article uses the core sample data released with [Ed-Fi Data Standard v3.3.1-b](/reference/data-exchange/data-standard/3/). If you have an extension that extends core entities with additional required
...
data, using the [Ed-Fi Bulk Load Client](../platform-dev-guide/utilities/bulk-load-client-utility.md) utility.
