...
![Sample.nupkg](https://edfidocs.blob.core.windows.net/$webhttps://edfidocs.blob.core.windows.net/$web/img/reference/ods-api/image2024-7-25_6-36-11.png)
...
![Sample SandboxAdmin $parameters for SQL Server](https://edfidocs.blob.core.windows.net/$webhttps://edfidocs.blob.core.windows.net/$web/img/reference/ods-api/image2021-2-12_17-5-39.png)

**Right-click** the server (or EdFi website) again and select **Start**.

![Sample SandboxAdmin $parameters for PostgreSQL](https://edfidocs.blob.core.windows.net/$webhttps://edfidocs.blob.core.windows.net/$web/img/reference/ods-api/image2021-2-12_17-7-5.png)
