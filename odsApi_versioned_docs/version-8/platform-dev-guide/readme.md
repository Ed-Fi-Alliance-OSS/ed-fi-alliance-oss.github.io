...
professional to understand and successfully implement Ed-Fi API v8.

## Audience

This documentation is for current and prospective Ed-Fi API platform
...
software developers. Developers of API clients will want to check out the
...
- [Representational state transfer (REST) services](https://www.ics.uci.edu/~fielding/pubs/dissertation/fielding_dissertation.pdf),
  see Chapter 5
