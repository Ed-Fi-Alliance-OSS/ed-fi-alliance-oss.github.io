...
| extensions | Enables API endpoints created for [Extensions](../extensibility-customization/extending-api-datamodel.md) loaded from the configured `ApiSchemaPath` directory. |
