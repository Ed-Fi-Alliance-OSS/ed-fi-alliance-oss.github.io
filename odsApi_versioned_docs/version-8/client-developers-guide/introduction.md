...
This documentation is for current and prospective Ed-Fi API client
implementers. Client implementers are generally software developers, database
administrators, or data integration developers. Client implementers interested
in the inner workings of an Ed-Fi API platform may also find the [Platform
Developers' Guide](../platform-dev-guide/readme.md) useful. Similarly,
platform hosts may find this information useful.
