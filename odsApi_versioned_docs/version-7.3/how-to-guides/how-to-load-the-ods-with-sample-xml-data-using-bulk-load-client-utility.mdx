...
v5.2](/reference/data-exchange/data-standard/). If you have an extension
...
* **Download the Sample XML** from the Ed-Fi Data Standard repository (See [Downloads](#downloads)). Save these files to: `Ed-Fi-SampleDataLoad\Sample XML`
* **Download the Descriptors** from the Ed-Fi Data Standard repository (See [Downloads](#downloads)). Save these files to: `Ed-Fi-SampleDataLoad\Bootstrap`
...
[Sample XML](https://github.com/Ed-Fi-Alliance-OSS/Ed-Fi-Data-Standard/tree/v6.0.0/Samples/Sample%20XML)
[Descriptors](https://github.com/Ed-Fi-Alliance-OSS/Ed-Fi-Data-Standard/tree/v6.0.0/Descriptors)

**Note:** Make sure to download files from the **Data Standard version that matches your environment**. The links above reference **v6.0.0** as an example.
