...
* Install the Ed-Fi Bulk Load Client from a PowerShell prompt using the
  ...
  dotnet tool install EdFi.Suite3.BulkLoadClient.Console --version 7.3.413 --tool-path <YourInstallFolder>
  ```
  ...
  Tool 'edfi.suite3.bulkloadclient.console' (version '7.3.413') was successfully installed.
  ```
