...
* **Download the TPDM Descriptors** to
  `Ed-Fi-TPDMDataLoad\Bootstrap\TPDM` folder (See [Downloads](#downloads)).
...
XML](https://github.com/Ed-Fi-Alliance-OSS/Ed-Fi-TPDM-Artifacts/tree/Data-Standard-v5.2.0/Samples/Sample%20XML)
[TPDM
Descriptors](https://github.com/Ed-Fi-Alliance-OSS/Ed-Fi-TPDM-Artifacts/tree/Data-Standard-v5.2.0/Descriptors)
