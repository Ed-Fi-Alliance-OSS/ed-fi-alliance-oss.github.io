...
* [EdFi.Suite3.Installer.SwaggerUI](https://dev.azure.com/ed-fi-alliance/Ed-Fi-Alliance-OSS/_artifacts/feed/EdFi@Release/NuGet/EdFi.Suite3.Installer.SwaggerUI/overview/7.3.20008) (Optional,
    not for production)
...
| Ed-Fi ODS Admin API                                                | `https://YOUR_SITE_OR_SERVER_NAME_HERE/AdminApi`  |
