...
* [EdFi.Suite3.Installer.SwaggerUI](https://dev.azure.com/ed-fi-alliance/Ed-Fi-Alliance-OSS/_artifacts/feed/EdFi@Release/NuGet/EdFi.Suite3.Installer.SwaggerUI/overview/7.3.33) (Optional,
    not for production)
* [EdFi.Suite3.RestApi.Databases.5.2.0](https://dev.azure.com/ed-fi-alliance/Ed-Fi-Alliance-OSS/_artifacts/feed/EdFi@Release/NuGet/EdFi.Suite3.RestApi.Databases.Standard.5.2.0/overview/7.3.2041)
...
value is `{schoolYearFromRoute:range(2020,2030)}` Where schoolYear is the Route section,
