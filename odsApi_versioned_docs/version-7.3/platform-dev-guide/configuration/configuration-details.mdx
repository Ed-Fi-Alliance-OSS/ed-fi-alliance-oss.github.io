...
<table>
  ...
  <tr style={{verticalAlign: 'top'}}>
    ...
    <td>true</td>
    <td>Includes the `link` objects in references in the data management API responses. Disabling this feature is a server-side optimization at the cost of potentially breaking integrations by clients that may utilize them.</td>
  </tr>
