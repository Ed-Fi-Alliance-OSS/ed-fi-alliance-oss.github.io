...
import fig1Diagram from './fig1-mermaid-diagram.mmd?raw';
import fig2Diagram from './fig2-resource-claims.mmd?raw';
import fig3Diagram from './fig3-claims-taxonomy-2026-08-28-173436.mmd?raw';
...
<Mermaid value={fig1Diagram} viewport />
...
<Mermaid value={fig2Diagram} viewport />
...
<Mermaid value={fig3Diagram} viewport />
...
- **Relationship-based strategies.** A family of strategies that authorize
  ...
  in the caller's claims. See
  [Relationship-Based Authorization](#relationship-based-authorization) for more
  details.
- **OwnershipBased.** Allows access to items based on ownership tokens
  ...
  token at each aggregate root at write time. See
  [Ownership-Based Authorization](#ownership-based-authorization) for more
  details.
- **Custom View-Based Authorization.** Provides a powerful and flexible
  ...
  and
  [How To: Use Custom View-Based Authorization](../../how-to-guides/how-to-use-custom-view-based-authorization.md)
