...
loading dependency order number. The dashed _Enrollment Data Domain_ node is an
abstraction placeholder — it expands into the full detail shown in the lower
section.

**Enrollment Data Domain (bottom)** — shows the entities loaded after student
...
| Dashed border | Abstraction placeholder (expands into Enrollment Data Domain) |

### Core Loading Sequence

<Mermaid value={coreDiagram} viewport />

### Enrollment Data Domain
