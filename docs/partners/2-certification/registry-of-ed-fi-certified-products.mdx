...
## Ed-Fi Student Information Systems API for Suite 3 Certification (no longer issued)
Note that Suite 3 certifications are no longer issued as of December 2024. See data standard [active versions](https://docs.ed-fi.org/reference/data-exchange/data-standards/#version-3x) for more information.

<CertificationTable certifications={certData.sisSuite3} />

## Ed-Fi Domain API for Suite 3 Certification (no longer issued)
Note that Suite 3 certifications are no longer issued as of December 2024. See data standard [active versions](https://docs.ed-fi.org/reference/data-exchange/data-standards/#version-3x) for more information.
