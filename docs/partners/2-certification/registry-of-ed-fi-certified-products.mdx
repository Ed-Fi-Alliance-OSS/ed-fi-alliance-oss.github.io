...
export function CertificationTable2({ certifications }) {
  return (
...
export function CertificationTable3({ certifications }) {
  return (
...
<CertificationTable3 certifications={certData.sisApiV4} />
