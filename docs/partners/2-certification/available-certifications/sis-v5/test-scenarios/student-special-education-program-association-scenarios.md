...
4. Update the "ideaEligibility" to FALSE for Student Special Education Program
   Association 2.
5. Exit the elementary school student from the special education program and provide an exit reason
...
| Resource                                   | Property Name                     | Is Collection | Data Type                         | Required | Scenario 1: POST                            | Scenario 2: POST                              | Scenario 3: PUT                             | Scenario 4: PUT                               | Scenario 5: PUT                               |
| ------------------------------------------ | --------------------------------- | ------------- | --------------------------------- | -------- | ------------------------------------------- | --------------------------------------------- | ------------------------------------------- | --------------------------------------------- | --------------------------------------------- |
| StudentSpecialEducationProgramAssociations | beginDate                         | FALSE         | date                              | REQUIRED | 8/23/\[Current School Year\]                | 8/23/\[Current School Year\]                  | 8/23/\[Current School Year\]                | 8/23/\[Current School Year\]                  | 8/23/\[Current School Year\]                  |
| StudentSpecialEducationProgramAssociations | endDate                           | FALSE         | date                              | REQUIRED |                                             |                                               |                                             |                                               | 5/23/\[Current School Year\]                  |
| StudentSpecialEducationProgramAssociations | reasonExitedDescriptor            | FALSE         | educationOrganizationReference    | REQUIRED |                                             |                                               |                                             |                                               | Transferred to regular education              |
...
| StudentSpecialEducationProgramAssociations | programReference                  | FALSE         | ReasonExitedDescriptor            | REQUIRED |                                             |                                               |                                             |                                               |                                               |
...
| StudentSpecialEducationProgramAssociations | specialEducationExitDate          | FALSE         | date                              | REQUIRED |                                             |                                               |                                             |                                               | 5/23/\[Current School Year\]                  |
