...
export default {
  sisApiV4: [
    ...
    },
    {
      ...
      documentation: {
        'Availability Statement':
          'https://ops.jupitered.com/help/?statereporting',
        Mappings: '',
      },
      supportResources: [
        {
  ...
  sisSuite3: [
    ...
    },
    {
      ...
      availability: 'Available to any LEA Florida, New Jersey, Rhode Island, South Dakota, Tennessee, Texas, Washington, Utah, others by request',
      documentation: {
        'Availability Statement':
