...
export default {
  managedODSAPI: [
    ...
    },
    {
      ...
      versionCompatibility: [
        'EdFi ODS/API versions 6.x and 7.x',
    ...
    */
    ...
    },
    {
      ...
      verifyingAgencies: [
        'Holdsworth Center, TX',
        'Boston Public Schools, MA',
        'New Mexico PED, NM',
      ],
      versionCompatibility: [
        'Ed-Fi ODS / API Suite 3 v5.3',
  ...
  apiConsumer: [
    ...
    },
    {
      ...
      versionCompatibility: [
        'Ed-Fi ODS/API for Suite 2 v2.5',
    ...
    },
    {
      ...
      versionCompatibility: [
        'Version 3x data standards and later',
    ...
    },
    {
      ...
      versionCompatibility: [
        ...
        'Ed-Fi Data Standard versions 3.3.1-b',
      ],
      availability: 'Available to any agency (all sizes) or vendor in the U.S.',
    },
    {
...

   {
    ...
    {
      logo: 'https://edfidocs.blob.core.windows.net/$web/img/partners/badging/panorama-education.png',
      productName: 'Panorama Pathways',
      provider: 'Panorama Education',
      website: 'https://www.panoramaed.com/products/pathways-graduation-tracking-tool',
      validThrough: 'September 16, 2027',
      verifyingAgencies: ['South Carolina Department of Education'],
      documentation: {
        'Mapping Document':
          'https://edfidocs.blob.core.windows.net/$web/assets/partners/badging/EdFi%20-%20Panorama%20Mapping%20Pathways%209.3.2025.xlsx',
      },
      versionCompatibility: 'Panorama Pathways has been tested against Ed-Fi API Suite 3, V5.3, 6.1, and 7.3 and Ed-Fi Data Standard versions 3.3.1-b through 5.2.0.',
      availability: 'Available to any agency (all sizes) or vendor in the U.S.',
    },
  ...
  implementationPartner: [
    {
      ...
      documentation: {
        'IDOE Ed-Fi 6.1 Vendor Documentation':
          'https://docs.google.com/spreadsheets/d/1b7Y36hqHfK66Mqzn1RrUmL8P64qYE-e4/edit#gid=1377605800',
    ...
    },
    {
      ...
      verifyingAgencies: [
        'Texas Computer Collaborative (Region 20)',
        'Hamilton County ESC',
      ],
      servicesPerformed: {
