...
doing field implementation work around the Ed-Fi Technology Suite stack, which may not
be directly relatable to a software product.

Many agencies are forming short term, project based relationships to perform
specific tasks with Ed-Fi Technology Suite - upgrades, system integrations, and
