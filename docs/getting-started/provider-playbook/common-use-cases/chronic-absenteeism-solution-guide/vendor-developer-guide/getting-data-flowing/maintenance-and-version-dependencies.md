# Maintenance and Version Dependencies

This Starter Kit is based on the **Ed-Fi ODS / API for Suite 3 v5.2.0**
Information on that specific API version can be found by looking at [Online API
Documentation and Sandbox - Chronic
Absenteeism-VDG](./online-api-documentation-and-sandbox.md)
