...
For those that don't have an Ed-Fi license to access the above link, the Cloud ODS Azure deployment scripts are also available in the new Ed-Fi Community Tools open source repository here: [https://github.com/Ed-Fi-Exchange-OSS/Ed-Fi-X-Ods-Deploy-Azure](https://github.com/Ed-Fi-Exchange-OSS/Ed-Fi-X-Ods-Deploy-Azure).
