...
This document lists some lessons-learned that the customer success team has come across in our use of the Profile feature that we did not find in the documentation.  This should be considered a supplement to the documentation  [API Profiles](/reference/ed-fi-api/platform-dev-guide/security/api-profiles) and  [How To: Add Profiles to the Ed-Fi ODS / API Solution](/reference/ed-fi-api/how-to-guides/how-to-add-profiles-to-the-ed-fi-ods-api).
