...
* Local or virtual machine development environment with the following:
  ...
  * The Ed-Fi ODS Admin App should be installed but NOT run for the first time ([Admin App v3.3 for ODS/API v6.0](/getting-started/community-tools/technology/ods-admin-app/getting-started/))
