...
* Local or virtual machine development environment with the following:
  * Ed-Fi ODS/API installed from source ([Getting Started - Source Code Installation](https://edfi.atlassian.net/wiki/spaces/ODSAPIS3V61/pages/18812000/Getting+Started+-+Source+Code+Installation)) . We have found that deploying 6.x versions of the ODS/API requires building the solution from source code so that the web application can be explicitly defined as 64-bit. More on that later…
  * The Ed-Fi ODS Admin App should be installed but NOT run for the first time ([Admin App v3.0 for ODS/API v6.0](https://edfi.atlassian.net/wiki/spaces/ADMIN/pages/25244486)
  * The Azure CLI should be installed [https://learn.microsoft.com/en-us/cli/azure/install-azure-cli-windows?tabs=azure-cli](https://learn.microsoft.com/en-us/cli/azure/install-azure-cli-windows?tabs=azure-cli)
...
![Create SQL DB Server additoinal settings](https://edfidocs.blob.core.windows.net/$web/img/edfi-exchange/guides/image-2023-3-27_0-13-40.png)

* Click **Next: Tags**
* Set any desired **Tag name** and its **values**

**![Create SQL DB Server Tags](https://edfidocs.blob.core.windows.net/$web/img/edfi-exchange/guides/image-2023-3-27_0-14-37.png)

**

* Go to **Review + create**

**![Create SQL DB Server Review](https://edfidocs.blob.core.windows.net/$web/img/edfi-exchange/guides/image-2023-3-27_0-17-19.png)
...
**![Deploy progress notification](https://edfidocs.blob.core.windows.net/$web/img/edfi-exchange/guides/image-2023-3-27_0-18-55.png)

**

* After the deployment is successful, select "Go to resource" or navigate manually to the created SQL server

![View SQL Server as resource](https://edfidocs.blob.core.windows.net/$web/img/edfi-exchange/guides/image-2023-3-27_0-21-21.png)
...
> * Click **Connect**
>
> **![SQL Server connect](https://edfidocs.blob.core.windows.net/$web/img/edfi-exchange/guides/image-2023-3-27_0-27-12.png)
>
> **
>
...
>
> ![Select Storage account](https://edfidocs.blob.core.windows.net/$web/img/edfi-exchange/guides/image-2023-3-27_1-13-22.png)
>
> * After returning to the export wizard, corroborate the information provided and click "Next"
>
> ![Export Settings](https://edfidocs.blob.core.windows.net/$web/img/edfi-exchange/guides/image-2023-3-27_1-15-45.png)
>
> * Corroborate the information and click "Finish"
>
> ![Review Export configuration](https://edfidocs.blob.core.windows.net/$web/img/edfi-exchange/guides/image-2023-3-27_1-17-31.png)
>
...
>
> ![Select Import Database](https://edfidocs.blob.core.windows.net/$web/img/edfi-exchange/guides/image-2023-3-27_0-49-24.png)
>
...
>
> ![Import database start wizard](https://edfidocs.blob.core.windows.net/$web/img/edfi-exchange/guides/image-2023-3-27_0-53-37.png)
>
...
>
> ![View active databases](https://edfidocs.blob.core.windows.net/$web/img/edfi-exchange/guides/image-2023-3-27_0-57-46.png)
>
> * You should get a notification with the database import request on your Azure portal notifications tab
>
> ![Import progress notification](https://edfidocs.blob.core.windows.net/$web/img/edfi-exchange/guides/image-2023-3-27_1-0-18.png)
>
...
>
> ![Import export history view](https://edfidocs.blob.core.windows.net/$web/img/edfi-exchange/guides/image-2023-3-27_1-2-54.png)
>
...
>
> **![SQL Server Login](https://edfidocs.blob.core.windows.net/$web/img/edfi-exchange/guides/image-2023-3-27_0-27-12.png)
>
> **
>
> * Select your local DB server name and choose **Windows Authentication**
...
>
> ![SSMS View tables](https://edfidocs.blob.core.windows.net/$web/img/edfi-exchange/guides/image-2023-3-27_0-29-52.png)
>
...
>
> **![SSMS Deploy task](https://edfidocs.blob.core.windows.net/$web/img/edfi-exchange/guides/image-2023-3-27_0-35-54.png)
>
> **
>
...
![View Key Vault created](https://edfidocs.blob.core.windows.net/$web/img/edfi-exchange/guides/image-2023-3-24_11-46-57.png)
...
![View Ed-Fi DB Secrets](https://edfidocs.blob.core.windows.net/$web/img/edfi-exchange/guides/image-2023-3-24_12-15-37.png)
...
![Access Policies](https://edfidocs.blob.core.windows.net/$web/img/edfi-exchange/guides/image-2023-3-24_14-23-29.png)
...
![VS Publish](https://edfidocs.blob.core.windows.net/$web/img/edfi-exchange/guides/VsPublishHL.png)
* Click Publish.
...
* Change the target Runtime from Portable to "win-x64"
![Selecting target runtime](https://edfidocs.blob.core.windows.net/$web/img/edfi-exchange/guides/VsPublishHL.png)
* Click Publish.
...
![Web Application Settings](https://edfidocs.blob.core.windows.net/$web/img/edfi-exchange/guides/image-2023-3-27_13-2-59.png)
...
![Ed-Fi Admin Secrets identifier](https://edfidocs.blob.core.windows.net/$web/img/edfi-exchange/guides/image-2023-3-26_22-45-43.png)

* **name:** must match the name of the database that you have in your appsettings.json
![App settings connection strings](https://edfidocs.blob.core.windows.net/$web/img/edfi-exchange/guides/image-2023-3-26_22-51-56.png)
Once done, you will end up with something similar to this
![Database table configuration](https://edfidocs.blob.core.windows.net/$web/img/edfi-exchange/guides/image-2023-3-26_22-57-35.png)
![View connection strings](https://edfidocs.blob.core.windows.net/$web/img/edfi-exchange/guides/image-2023-3-26_23-0-51.png)
