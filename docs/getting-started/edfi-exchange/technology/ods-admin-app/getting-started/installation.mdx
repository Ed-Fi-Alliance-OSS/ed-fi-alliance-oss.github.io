...
* The Admin App provides an interface to administer an Ed-Fi ODS / API.
  ...
  [binary installation](/reference/ods-api/6.2/getting-started/binary-installation)
  or [source code
  installation](/reference/ods-api/6.2/getting-started/source-code-installation).
