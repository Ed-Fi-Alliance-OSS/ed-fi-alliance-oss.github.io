...
Most Ed-Fi opens-source product documentation – including the documentation for the core Ed-Fi ODS / API platform – can be located in the [Reference](/reference/ed-fi-api) section of Docs. Those documents provide the most detailed accounts of how to use Ed-Fi's tools.
