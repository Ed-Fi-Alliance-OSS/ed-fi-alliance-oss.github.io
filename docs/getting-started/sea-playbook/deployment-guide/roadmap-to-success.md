...
This page helps you understand the deployment architecture and make the critical decisions you need to make _before_ beginning the installation process.
...
For configuration details and supported providers, see [Configuring an Identity Provider for Ed-Fi Admin App](/reference/admin-app/system-administrators/identity-provider).
...
For installation and configuration details, see the [Yopass Administrator Guide](/reference/admin-app/system-administrators/yopass-administrators-guide).
