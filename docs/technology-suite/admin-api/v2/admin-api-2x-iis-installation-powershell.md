...
This version of the Admin API has been tested and can be installed for use with the Ed-Fi ODS / API v7.1. See the [Ed-Fi Technology Version Index](https://edfi.atlassian.net/wiki/display/ETKB/Ed-Fi+Technology+Version+Index) for more details.
...
![](./attachments/image2024-5-7_13-10-5.png)
...
![](./attachments/Screenshot%202023-09-18%20at%2013.31.52.png)
