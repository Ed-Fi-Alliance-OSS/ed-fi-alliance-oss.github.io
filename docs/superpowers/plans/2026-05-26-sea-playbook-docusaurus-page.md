# SEA Playbook Docusaurus Page Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development
> (recommended) or superpowers:executing-plans to implement this plan task-by-task.
> Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Create a single Docusaurus page at
`docs/getting-started/sea-playbook/ed-fi-overview-and-implementation-playbook.md` that renders
the 36-slide SEA Ed-Fi Overview and Implementation Playbook using Mermaid diagrams, PNG renders,
prose, and Markdown tables, and link it from the existing section readme.

**Architecture:** Single `.md` file with `sidebar_position: 2` appended incrementally across
tasks. Five PNG slide renders copied to `static/img/sea-playbook/` as placeholders (Azure blob
upload is deferred). The existing `readme.md` gains one new bullet at the top of its KB list.

**Tech Stack:** Docusaurus 3, Markdown, Mermaid

---

### Task 1: Copy PNG assets

**Files:**

- Create: `static/img/sea-playbook/page-04.png`
- Create: `static/img/sea-playbook/page-05.png`
- Create: `static/img/sea-playbook/page-08.png`
- Create: `static/img/sea-playbook/page-11.png`
- Create: `static/img/sea-playbook/page-30.png`

- [ ] **Step 1: Create destination directory and copy the five files**

Run in PowerShell from repo root:

```powershell
New-Item -ItemType Directory -Force "static\img\sea-playbook"
@("page-04","page-05","page-08","page-11","page-30") | ForEach-Object {
  Copy-Item `
    "conversions\sea-playbook\sea-ed-fi-playbook\sea-ed-fi-playbook\assets\images\pages\$_.png" `
    "static\img\sea-playbook\$_.png"
}
```

Expected: No errors; 5 `.png` files created under `static/img/sea-playbook/`

- [ ] **Step 2: Verify**

```powershell
Get-ChildItem "static\img\sea-playbook"
```

Expected output lists: `page-04.png  page-05.png  page-08.png  page-11.png  page-30.png`

- [ ] **Step 3: Commit**

```bash
git add static/img/sea-playbook/
git commit -m "Add SEA playbook PNG slide renders as image placeholders"
```

---

### Task 2: Create page — frontmatter through adoption charts (slides 1–5)

**Files:**

- Create: `docs/getting-started/sea-playbook/ed-fi-overview-and-implementation-playbook.md`

- [ ] **Step 1: Create the file**

Write `docs/getting-started/sea-playbook/ed-fi-overview-and-implementation-playbook.md`
with the following content (note: Mermaid blocks use triple backticks inside the file itself):
...
```bash
npm run lint:folder docs/getting-started/sea-playbook
```
...
```bash
git add docs/getting-started/sea-playbook/ed-fi-overview-and-implementation-playbook.md
git commit -m "Add SEA playbook page: intro, pain points, mission, adoption"
```

---

### Task 3: Add impact sections (slides 6–7)

**Files:**

- Modify: `docs/getting-started/sea-playbook/ed-fi-overview-and-implementation-playbook.md`
...
_Source: Nebraska Department of Education_
...
```bash
git add docs/getting-started/sea-playbook/ed-fi-overview-and-implementation-playbook.md
git commit -m "Add SEA playbook page: Nebraska and Michigan impact sections"
```

---

### Task 4: Add implementation approaches section (slide 8)
...
```bash
git add docs/getting-started/sea-playbook/ed-fi-overview-and-implementation-playbook.md
git commit -m "Add SEA playbook page: implementation approaches section"
```

---

### Task 5: Add Reporting + Data Hub detail (slides 9–12)
...
The content to append contains four sub-sections. Each Mermaid block uses triple backticks.
Append exactly:
...
```bash
git add docs/getting-started/sea-playbook/ed-fi-overview-and-implementation-playbook.md
git commit -m "Add SEA playbook page: Reporting + Data Hub phases, architecture, team, risk"
```

---

### Task 6: Add Implementation header and Four Stages (slides 14–15)
...
```bash
git add docs/getting-started/sea-playbook/ed-fi-overview-and-implementation-playbook.md
git commit -m "Add SEA playbook page: Implementation section header and Four Stages"
```

---

### Task 7: Add Planning phase (slides 16–22)
...
Replace `[MERMAID_PLANNING_TASKS]` with:
...
```bash
git add docs/getting-started/sea-playbook/ed-fi-overview-and-implementation-playbook.md
git commit -m "Add SEA playbook page: Planning phase"
```

---

### Task 8: Add Pilot, Parallel, and Production phases (slides 23–28)
...
Replace `[MERMAID_PILOT_TASKS]` with:
...
Replace `[MERMAID_PARALLEL_TASKS]` with:
...
```bash
git add docs/getting-started/sea-playbook/ed-fi-overview-and-implementation-playbook.md
git commit -m "Add SEA playbook page: Pilot, Parallel, and Production phases"
```

---

### Task 9: Add Implementation Best Practices section (slides 29–35)
...
Replace `[MERMAID_VENDOR_COMMS]` with:
...
Replace `[MERMAID_LEA_COMMS]` with:
...
Replace `[MERMAID_DATA_PORTAL]` with:
...
```bash
git add docs/getting-started/sea-playbook/ed-fi-overview-and-implementation-playbook.md
git commit -m "Add SEA playbook page: Implementation Best Practices section"
```
...
- Modify: `docs/getting-started/sea-playbook/readme.md`

- [ ] **Step 1: Add link at the top of the SEA Knowledge Base list**

In `docs/getting-started/sea-playbook/readme.md`, find this line:

```
* [Project Planning](./project-planning/readme.md)
```

Insert one new line immediately before it:

```
* [Ed-Fi Overview and Implementation Playbook](./ed-fi-overview-and-implementation-playbook.md)
```

The "SEA Knowledge Base" bullet list should now begin with the new entry.
...
```bash
git add docs/getting-started/sea-playbook/readme.md
git commit -m "Link to new SEA playbook overview page from section readme"
```
...
- [ ] **Step 1: Run full section lint**

```bash
npm run lint:folder docs/getting-started/sea-playbook
```

Expected: Zero errors across all files in the section
...
Open `http://localhost:3000/getting-started/sea-playbook/ed-fi-overview-and-implementation-playbook`
and verify:

- Title "Ed-Fi Overview and Implementation Playbook" appears
- All five Mermaid diagrams render (no error boxes)
- Five PNG images load (adoption charts, approaches table, team table, task assignment table)
- Markdown tables display with correct columns
- `:::tip` admonitions render as styled callout boxes
- The page appears in the left sidebar at position 2 under "State Education Agencies -
  Implementation Playbook"

- [ ] **Step 3: Verify sidebar link from readme**

Open `http://localhost:3000/getting-started/sea-playbook` and confirm the new bullet appears
at the top of the SEA Knowledge Base list.
