...
2. **Define and build the extension.** See the [How To: Extend the Ed-Fi ODS /
   ...
   Example](/reference/ed-fi-api/how-to-guides/how-to-extend-the-ed-fi-ods-api-alternative-education-program-example)
...
3. **Create an Extension Plugin.** See the [How To: Create an
   Extension](/reference/ed-fi-api/how-to-guides/how-to-create-an-extension-plugin)
   page.
4. **Deploy an Extension Plugin.** See the [How To: Deploy an
   Extension](/reference/ed-fi-api/how-to-guides/how-to-deploy-an-extension-plugin)
   page.
