...
* The Admin App provides an interface to administer an Ed-Fi ODS / API.
  ...
  configurations include on-premises installation via [binary installation](https://edfi.atlassian.net/wiki/spaces/ODSAPIS3V62/pages/18219081/Getting+Started+-+Binary+Installation)
  or [source code
