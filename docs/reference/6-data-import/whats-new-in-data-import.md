...
* DI-1337 - .NET 8 Update
* DI-1336 - ODS/API 7.x compatibility
* DI-1358 - ODS/API 7.x compatibility for data map templates
* DI-1366 - Add fields into the ingestion log for both UI and Serilog ingestion logs
* DI-1353 - DataImport v2.1 error saving DataMap with too many fields (field contrib)
* DI-1359 - Fix .yml file to raise DataImport in Docker
* DI-1365 - Refresh Button Feedback Enhancement (field contrib)
* DI-1369 - UI Fix: The columns in 'Data Map' are not shown with the correct distribution, everything is together
...
* DI-1008 - Update DI versioning/release process to match Ed-Fi modern release practice
* DI-1176 - RestSharp Vulnerability & and other high priority dependabot alerts
* DI-1180 - Change PGBOUNCER\_LISTEN\_PORT variable in docker settings
* DI-1210 - Remove duplicate column validation for manual uploads
* DI-1242 - Move AllowUserRegistration to appsettings
* DI-1249 - Error log not displaying row number during transformload run on docker
* DI-1265 - Data Import v 1.3.2 does not log missing lookup failures
* DI-1277 - Serilog for Ingestion Log
* DI-1282 DI-1278 - Implement ability for account lockout and reset
* DI-1281 - Combine Data Import web package and installer
* DI-1249 - Error log not displaying row number during transformload run on docker
* DI-1258 - Update or Replace System.Data.SqlClient in Data Import
* DI-1292 - 'Last Executed' row is not updated after to run the transform load

## What's New in Data Import v2.0

The following improvements and fixes were made in Data Import v2.0:

* DI-1169 - Multi-threading support for Data Import
* DI-1230 - Open sourcing of Data Import v2.0 with an Apache 2.0 license
...
* EDFI-189 - "installation issues on Windows 2012"
* EDFI-198 - "ODS/API key/secret debugging"
* EDFI-207 - "PowerShell integration (representing multiple field requests)"
...
* EDFI-178 - "Configuration updated and files up to 200MB tested on Windows Server & IIS 10
* EDFI-174 - "URL handling improvements"
...
* EDFI-157 - "FTPS issues and labels fixed"
* EDFI-172 - "Year-specific issues fixed"
