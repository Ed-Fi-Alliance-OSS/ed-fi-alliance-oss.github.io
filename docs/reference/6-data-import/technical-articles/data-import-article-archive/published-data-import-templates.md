...
In order to access these templates you need to install and register Data Import. See [Data Import - Getting Started](../../../data-import/getting-started.md) for more details. *(This information is available to Ed-Fi licensees only, and requires you to be logged in.)*
