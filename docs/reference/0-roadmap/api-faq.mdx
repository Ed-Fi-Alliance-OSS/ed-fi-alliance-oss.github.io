...
<div class="container table">
  ...
  <div class="row col--tr">
      ...
      <div class="col col--9 col--td" style={{backgroundColor: "var(--ifm-color-info-lightest)"}}>patch</div>
...
* ODS/API 7.3x will continue to receive annual feature enhancements (and bug
