...
school year 2027-2028. In the table below, the label "patch" means that the
...
<div class="container table">
  ...
  <div class="row col--tr">
      ...
      <div class="col col--1 col--td" style={{backgroundColor: "var(--ifm-color-info-lightest)"}}>patch</div>
      <div class="col col--9 col--td">&nbsp;</div>
  </div>
  <div class="row col--tr-alt">
      <div class="col col--2 col--td">ODS/API 6.2</div>
      <div class="col col--3 col--td" style={{backgroundColor: "var(--ifm-color-info-lightest)"}}>patch</div>
      <div class="col col--7 col--td">&nbsp;</div>
  </div>
  <div class="row col--tr">
      <div class="col col--2 col--td">ODS/API 7.3</div>
      <div class="col col--7 col--td" style={{backgroundColor: "var(--ifm-color-info-lightest)"}}>patch</div>
      <div class="col col--3 col--td">&nbsp;</div>
  </div>
  <div class="row col--tr-alt">
...
* ODS/API 73x will continue to receive annual feature enhancements (and bug
