...
[Roadmap for the Ed-Fi Technology Suite](./readme.mdx).
...
The Alliance publishes its roadmap at [Roadmap for the Ed-Fi Technology Suite](./readme.mdx).
Organizations using software products released by the Ed-Fi Alliance are advised to follow the roadmap
...
![Release cadence chart](https://edfidocs.blob.core.windows.net/$web/img/reference/release-cadence.png)
...
Releases](../1-data-exchange/versioning-and-releases.md).
