...
# Roadmap for the Ed-Fi Technology Suite

The Roadmap for the Ed-Fi Technology Suite provides information on the development plans and
...
* The [Ed-Fi Technology Suite Version Matrix](./supported-versions.md) lists
  the Data Standard and application versions that are currently supported and
  maintained, as well as their relationships with each other.
* [Ed-Fi Data And API Standard Release Cadence](./cadence.mdx) describes
  important patterns in releases of the Ed-Fi Technology Suite.

## How to Read the Roadmap for the Ed-Fi Technology Suite
...
<img
  alt="Screenshot of the Roadmap for the Ed-Fi Technology Suite in GitHub"
  src={RoadmapScreen}
