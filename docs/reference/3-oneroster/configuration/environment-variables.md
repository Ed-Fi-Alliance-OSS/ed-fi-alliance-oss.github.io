...
| `MAX_PAGE_SIZE` | 100 | Optional: maximum number of records a single collection request may return. Requests with a larger 'limit' are clamped to this value rather than rejected. Must be a positive integer no greater than 10000. |
