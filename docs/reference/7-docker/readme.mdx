...
1. Run installations from the official binary distributions and documentation:
    ...
    1. Follow steps 1 and 2 in [Sandbox Installation Steps: Step
        2](/reference/ed-fi-api/platform-dev-guide/configuration/api-client-and-ods-instance-configuration),
...
<details>
  ...
  * `odsContextRouteTemplate` - Defines the route parameter template used to
    ...
    constraints](/reference/ed-fi-api/platform-dev-guide/configuration/context-based-routing-for-year-specific-ods)
