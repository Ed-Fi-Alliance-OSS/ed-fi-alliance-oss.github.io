...
![MetaEd IDE version](../img/image-2023-3-28_10-16-31.png)
...
![Install from VSIX](../img/2023-03-28_10-13-18.png)
...
![MetaEd controls in a non-MetaEd project](../img/image2023-2-21_15-57-24.png)
...
![Descriptors cannot be included in domain files](../img/image2023-2-21_13-37-38.png)
...
![Descriptors cannot be included in domain files](../img/image2023-2-21_14-40-37.png)
...
![ODS/API versions](../img/image-2024-3-22_13-20-48.png)
...
![Output panel](../img/image2023-2-17_11-52-46.png)
...
![Data model versions](../img/image2023-2-21_15-0-22.png)

![Data model versions](../img/image2023-2-21_15-4-26.png)

![Data model versions](../img/image2023-2-21_15-5-0.png)

![Data model versions](../img/image2023-2-21_15-5-32.png)

### I added a Data Standard project and get an error message with the wrong ODS/API version

![Data Standard project](../img/image-2023-6-22_14-17-46.png)
...
![Workspace settings](../img/image-2023-6-22_14-24-14.png)

### I tried to deploy, but received a message about checking the ODS/API path

![ODS/API path error](../img/image2023-3-8_9-59-4.png)
...
* You have an extension data model, but do not have a C# extension project in
    ...
    like this in such a case: ![Output](../img/image2023-3-8_10-2-33.png)
...
![Build error](../img/image2023-2-21_14-42-20.png)
...
![No viable alternative at input `<EOF>`](../img/no.viable.alternative.png)

### The Interchange XSD files generated by the build are invalid when opened in an XML editor

![Schema location error](../img/image2017-4-5_10-51-53.png)
...
![Schema location error](../img/image2023-2-21_14-50-55.png)

Your interchange files should now validate properly in an XML editor.

![Validated interchange files](../img/image2017-4-5_10-58-4.png)
...
![Non-MetaEd projects in the workspace](../img/image-2023-6-23_9-44-37.png)
...
![File format](../img/image-2023-6-23_9-47-27.png)

Click on that text to initiate saving in the correct format (UTF-8), as shown in
these screenshots.

![Save with encoding](../img/save_with_encoding.jpg)

![Save with encoding](../img/image-2023-6-23_9-51-18.png)
