...
:::info
 ...
 clients, see instead the Applications section in [Endpoints in Admin API
  1.x](getting-started/admin-api-1.x/technical-articles/endpoints-in-admin-api-1x.md).
:::
...
:::info
 ...
 1.x](getting-started/admin-api-1.x/technical-articles/endpoints-in-admin-api-1x.md). They are not
...
:::warning
 ...
 client registration see [First-Time Configuration for Admin API
  1.x](getting-started/admin-api-1.x/installation-for-odsapi-5x-6x/first-time-configuration-for-admin-api-1x.md).
 :::
