...
*   [Step 3. ODS / API URL Configuration](#step-3-ods-api-url-configuration)
...
*   [](#)
[](#AdminAppv1.7forODS/APIv3.3-)*   [](#)[Step 6. Checking Folder Permission (Optional)](#step-6-checking-folder-permission-optional)
*   [](#)
[](#AdminAppv1.7forODS/APIv3.3-.1)*   [](#)[Step 7. Securing the Admin App](#step-7-securing-the-admin-app)
*   [Step 8. Admin App Licensing & Configuration](#step-8-admin-app-licensing-configuration)
*   [Step 9. Restart the ODS / API](#step-9-restart-the-ods-api)
...
**![](./attachments/image2019-8-2_13-50-33.png)
...
![](./attachments/image2019-8-2_13-48-57.png)
...
### **![](./attachments/image2020-1-23_14-28-11.png)

**

**![](./attachments/image2020-1-23_14-30-55.png)
...
For checking permission *–* right-click the folder then choose Properties, select Security tab to verify the "Group or user names" section has EdFi.AdminApp with full control.

### **![](./attachments/image2020-1-23_15-12-45.png)
...
![](./attachments/applicationpage4.JPG)

Clicking on Add Application will show following screen.

![](./attachments/Applicationpage5.JPG)
...
![](./attachments/applicationpage13.JPG)
...
![](./attachments/Applicationpage14.JPG)
...
![](./attachments/Applicationpage15.JPG)
