...
the Ed-Fi ODS / API Admin App for Suite 3 v2.3.
...
* A SQL Server 2012 or higher, or Postgres 11 or higher database server as also
  in use with your ODS / API v3.4 - v5.3.0 installation.  .NET Framework 4.8
  Runtime is still needed for the PowerShell installations scripts.
...
Download and
unzip [AdminAppInstaller.2.3.zip](https://odsassets.blob.core.windows.net/public/adminapp/AdminAppInstaller.2.3.1.zip).
