...
* [Admin App for Suite 3 v2.4](#admin-app-for-suite-3-v24)
...
_**Note:** This step is only for ODS / API versions is 3.4 through 5.2.  ODS / API versions 5.3 and higher do not require a service restart._
