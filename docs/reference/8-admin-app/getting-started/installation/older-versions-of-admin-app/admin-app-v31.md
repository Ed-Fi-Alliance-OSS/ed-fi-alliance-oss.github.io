...
the Ed-Fi ODS / API Admin App v3.1 for ODS/API 3.4 to 6.1.
...
Docker image for Admin App 3.1 is available at:
...
:::info note:
  ...
   `.zip,` or use the PowerShell command from Step 1 below. **Admin App v3.1:**
...
:::info note:
  The following is the DockerHub repo for **Admin App v3.1.2 Docker
...
* Installer and binaries for Admin App 3.1:
  [EdFi.Suite3.ODS.AdminApp.Web.3.1.2.nupkg](https://dev.azure.com/ed-fi-alliance/Ed-Fi-Alliance-OSS/_artifacts/feed/EdFi/NuGet/EdFi.Suite3.ODS.AdminApp.Web/overview/3.1.2)
