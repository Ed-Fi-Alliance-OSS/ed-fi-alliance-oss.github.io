...
![SQL Server Installation](../../img/SQLServerInstallationStep1.png)

1. When prompted, select the following features:

  ![Feature Installation](../../img/Feature%20Installation.png)

2. Use the default instance named **MSSQLSERVER**.
  ![SQL Server Instance](../../img/SQLDefault.png)

3. Select either **Windows Authentication Mode** or **Mixed Mode.**
  ![SQL Server Authentication Mode](../../img/SQLAuth.png)
...
![SQL Server Installation](../../img/SQLServerInstallationStep2.png)
...
![Visual Studio 2022](../../img/image2022-3-7_18-51-45.png)
...
![PostgreSQL Installer](../../img/postgresqldbdownload.png)

Download the version 13.x installer.

![PostgreSQL Installer](../../img/postgresqldbdownload2.png)

Click **Next**.

![PostgreSQL Installer](../../img/postgresqldbdownload3.png)

Click **Next**.

![PostgreSQL Installer](../../img/postgres-install-3.jpg)
...
![PostgreSQL Installer](../../img/postgres-install-5.jpg)

Enter a password for the postgres superuser.

Click **Next**.

![PostgreSQL Installer](../../img/postgres-install-6.jpg)

Enter port **5432** (default).

Click **Next**.

![PostgreSQL Installer](../../img/postgres-install-7.jpg)

Click **Next**.

![PostgreSQL Installer](../../img/postgresqldbdownload4.png)

Click **Next**.

![PostgreSQL Installer](../../img/postgres-install-9.jpg)
...
![Step 3 Fig 2](../../img/Step-3-Fig-2.png)
...
2. Under **System variables**, select **New...**
    ...
    ![System Variables](../../img/image2024-5-15_16-33-28.png)

3. For **Variable name**, enter **StandardVersion**
4. For **Variable value**, enter **4.0.0,** and press **OK**.

    ![Variable Value](../../img/image2024-5-15_16-31-34.png)
...
![Loaded PowerShell Scripts](../../img/image2021-2-4_12-2-23.png)
...
![initdev](../../img/image2021-2-4_12-2-39.png)
...
![initdev execution](../../img/image2021-2-4_12-3-8.png)
...
![Code Generation](../../img/Step-5-Fig-1.png)
...
1. Open the Developer Command Prompt for Visual Studio.
    ...
    ![Developer Command Prompt](../../img/vs_step5.png)
...
1. Select the **Set StartUp Projects…** context menu by right-clicking on the
    solution file in the Solution Explorer. ![Startup Projects](../../img/startup2.png)
...
2. Within the Startup Project property page, select the **Multiple startup
    ...
    * EdFi.Ods.WebApi
    ...
    ![Startup Projects](../../img/startup3.png)
...
![Startup Projects](../../img/Step-7-Fig-1.png)
...
![Sandbox Administration Portal](../../img/sandbox.png)
...
![ODS API Documentation](../../img/image-2023-11-28_15-26-31.png)
...
![ODS API Documentation](../../img/image2020-10-18_16-45-58.png)
