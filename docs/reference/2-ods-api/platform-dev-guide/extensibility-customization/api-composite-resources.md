...
![Sample-Composite](/img/reference/ods-api/Sample-Composite.png)
...
![API Section](/img/reference/ods-api/API%20Section.png)
...
![Many-to-Many](/img/reference/ods-api/Many-to-Many.png)
