...
![Logical configuration](../../img/image2015-11-16%208-35-34.png)
...
![Two-server deployment](../../img/image17.png)
...
![Relationship between databases and websites](../../img/image2015-11-16%208-58-14.png)
...
* The local IIS site used to host your web application has site bindings
    ...
    3. Select type **https** then select the SSL certificate you wish to
        ...
        ![SSL certificate](../../img/image2022-12-7_15-40-25.png)
...
7. Fill in the application name and the server location that you have published
    ...
    ![Name and location](../../img/image05.png)

8. Click **OK**.

9. The application is ready to use.

    ![Ready to use](../../img/image07.png)
...
7. Fill in the application name and the server location that you have published
    ...
    ![Name and location](../../img/image16.png)

8. Click **OK**.

9. The application is ready to use.

    ![Ready to use](../../img/image-2023-6-5_10-41-38.png)
