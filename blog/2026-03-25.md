...
This post has been updated to reflect the latest implementation. The most significant change since its original publication is that **change tracking is now included** (see [Change Tracking and Change Queries](#change-tracking-and-change-queries) below).
