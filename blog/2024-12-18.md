...
See  [What's new in v5.2](/reference/data-exchange/data-standard/5/whats-new/whats-new-v52) for more detailed information on these and other changes. Also keep eye on this blog in January, as we are preparing a detailed list of new or modified API endpoints.
...
See [What's New in this Release](/reference/ed-fi-api/whats-new/whats-new-in-this-release) for detailed information.
