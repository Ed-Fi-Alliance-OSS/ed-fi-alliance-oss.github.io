...
utility](/reference/ed-fi-api/platform-dev-guide/utilities/smoke-test-utility) and
[bulk load
utility](/reference/ed-fi-api/platform-dev-guide/utilities/bulk-load-client-utility).
