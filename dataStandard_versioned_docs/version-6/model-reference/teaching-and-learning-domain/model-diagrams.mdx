...
[Download detailed UML diagram](./TeachingAndLearning.mmd)
...
<Mermaid value={diagramCourseCatalogSimple} viewport />

#### Detailed Teaching and Learning, Course Catalog Model UML Diagram

<Mermaid value={diagramCourseCatalogDetailed} viewport />

[Download detailed UML diagram](./TeachingAndLearning-CourseCatalog.mmd)
...
<Mermaid value={diagramSectionsAndProgramsSimple} viewport />

#### Detailed Teaching and Learning, Sections and Programs Model UML Diagram

<Mermaid value={diagramSectionsAndProgramsDetailed} viewport />

[Download detailed UML diagram](./TeachingAndLearning-SectionsAndPrograms.mmd)
