...
import diagramSimple from './StudentHealth-simple.mmd?raw';
import diagramDetailed from './StudentHealth.mmd?raw';
...
[Link to Large Diagram](./StudentHealth-simple.mmd)

## Detailed Student Health Model UML Diagram

<Mermaid value={diagramDetailed} />

[Link to Large Diagram](./StudentHealth.mmd)
