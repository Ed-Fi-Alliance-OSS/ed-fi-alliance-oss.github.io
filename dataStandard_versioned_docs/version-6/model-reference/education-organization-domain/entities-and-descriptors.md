...
| EducationOrganizationIdentificationCode | Holds different identity codes for an education organization. |
...
| EducationOrganization | AddressType | The set of elements that describes an address, including the street address, city, state, and ZIP code. | Orthodox | Yes | Yes | Yes |
...
| EducationOrganizationIdentificationCode | EducationOrganizationIdentificationSystem | A coding scheme that is used for identification and record-keeping. | Orthodox |     | Yes |     |
| Local Education Agency <br /> PostSecondaryInstitution <br /> School <br /> StateEducationAgency | FederalLocaleCode | The federal locale code associated with an education organization. |     |     |     |     |
