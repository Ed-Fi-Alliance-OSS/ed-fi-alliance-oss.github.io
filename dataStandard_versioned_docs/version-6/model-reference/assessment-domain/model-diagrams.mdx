...
[Download detailed UML diagram](./Assessment.mmd)
...
<Mermaid value={diagramStandardsSimple} viewport />

#### Assessment, Detailed Learning Standards Model UML Diagram

<Mermaid value={diagramStandardsDetailed} viewport />

[Download detailed UML diagram](./Assessment-Standards.mmd)
...
<Mermaid value={diagramMetaDataSimple} viewport />

#### Assessment, Detailed Assessment Metadata Model UML Diagram

<Mermaid value={diagramMetaDataDetailed} viewport />

[Download detailed UML diagram](./Assessment-AssessmentMetaData.mmd)
...
<Mermaid value={diagramStudentAssessmentSimple} viewport />

#### Assessment, Detailed Student Assessment Model UML Diagram

<Mermaid value={diagramStudentAssessmentDetailed} viewport />

[Download detailed UML diagram](./Assessment-StudentAssessment.mmd)
