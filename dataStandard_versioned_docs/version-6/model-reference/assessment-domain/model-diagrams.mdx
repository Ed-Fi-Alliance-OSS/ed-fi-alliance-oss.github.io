...
import diagramSimple from './Assessment-simple.mmd?raw';
import diagramDetailed from './Assessment.mmd?raw';
import diagramStandardsSimple from './Assessment-Standards-simple.mmd?raw';
import diagramStandardsDetailed from './Assessment-Standards.mmd?raw';
import diagramStudentAssessmentSimple from './Assessment-StudentAssessment-simple.mmd?raw';
import diagramStudentAssessmentDetailed from './Assessment-StudentAssessment.mmd?raw';
import diagramMetaDataSimple from './Assessment-AssessmentMetaData-simple.mmd?raw';
import diagramMetaDataDetailed from './Assessment-AssessmentMetaData.mmd?raw';
...
[Link to Large Diagram](./Assessment-simple.mmd)

## Detailed Assessment Model UML Diagram

<Mermaid value={diagramDetailed} />

[Link to Large Diagram](./Assessment.mmd)
...
<Mermaid value={diagramStandardsSimple} />

[Link to Large Diagram](./Assessment-Standards-simple.mmd)

#### Assessment, Detailed Learning Standards Model UML Diagram

<Mermaid value={diagramStandardsDetailed} />

[Link to Large Diagram](./Assessment-Standards.mmd)
...
<Mermaid value={diagramMetaDataSimple} />

[Link to Large Diagram](./Assessment-AssessmentMetaData-simple.mmd)

#### Assessment, Detailed Assessment Metadata Model UML Diagram

<Mermaid value={diagramMetaDataDetailed} />

[Link to Large Diagram](./Assessment-AssessmentMetaData.mmd)
...
<Mermaid value={diagramStudentAssessmentSimple} />

[Link to Large Diagram](./Assessment-StudentAssessment-simple.mmd)

#### Assessment, Detailed Student Assessment Model UML Diagram

<Mermaid value={diagramStudentAssessmentDetailed} />

[Link to Large Diagram](./Assessment-StudentAssessment.mmd)
