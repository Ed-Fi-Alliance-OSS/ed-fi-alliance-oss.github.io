...
- expanding core coverage of Educator Program with new domains such as Credential, Educator Preparation Program, Path, Performance Evaluation, and Recruiting & Staffing.
...
consult: [Ed-Fi Data Exchange Standards](https://docs.ed-fi.org/reference/data-exchange/).

For information on future Data Standard releases, please consult the [Ed-Fi
Technology Roadmap](https://docs.ed-fi.org/reference/roadmap/)
